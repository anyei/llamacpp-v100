...
extern "C" {
    ...
    // Batched blocking reads (meta backend star reduce): all requests are issued before
    // any response is read, so independent transfers overlap instead of paying one full
