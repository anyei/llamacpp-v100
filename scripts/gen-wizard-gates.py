...
CLASS = {
    ...
    "tune": [
        ...
        "LLAMA_SPEC_MTP_FUSED", "LLAMA_SPEC_TREE_CONF",
    ],
    "diag": [
        "GGML_META_BOUNDARY_STATS", "GGML_META_TIMING", "GGML_META_DEBUG",
        "GGML_META_DEBUG_REDUCE", "GGML_META_DEBUG_BSUM", "GGML_META_NO_DELAY", "GGML_META_NO_STAR",
        "GGML_META_LOCAL_COMM",
        "GGML_META_NO_FUSED", "LLAMA_CB_CHUNK_ONLY", "GGML_RPC_STATS", "GGML_RPC_DEBUG",
        ...
        "GGML_META_ZL_STATS", "GGML_META_ZL_DEBUG", "GGML_META_UNION_STATS", "LLAMA_EXPERT_PROFILE_IDS", "LLAMA_EXPERT_MASK",
        "GGML_META_EXPERT_DEFER_VERIFY", "GGML_META_DEBUG_UPLOAD",
        "GGML_CUDA_GRAPH_TRACE",
    ],
    "danger": [
        "GGML_META_PROBE_DEFER_GATHER", "GGML_META_PROBE_NO_WRITEBACK",
        "GGML_META_EXPERT_DEFER_PREFILL",
        "LLAMA_TRUNC_ARR", "LLAMA_META_DUP_DEVICE",
        "GGML_CUDA_INJECT_COMPUTE_FAIL", "GGML_RPC_DEBUG_FAIL_ALLOC",
        "GGML_VBUF_DEBUG_FAIL",
